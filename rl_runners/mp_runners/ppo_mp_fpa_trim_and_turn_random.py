...
if __name__ == '__main__':
    ...
    hyperparams = load_ppo_hyperparams("../../saved_hyperparams/ppo_random_mp")
    model = PPO('MlpPolicy', env, verbose=1, **hyperparams, tensorboard_log="../../tmp/mp/PPO/")
    model.learn(total_timesteps=250000, callback=MPTensorboardCallback())
    model.save('ppo_random_mp_fpa_trim_and_turns')
