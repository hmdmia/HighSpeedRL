...
variation = np.array([15000, 0, 0, 1000, 5*3.14159/180, 0])
...
if __name__ == '__main__':
    ...
    hyperparams = load_ppo_hyperparams("../../saved_hyperparams/ppo_random_start_params")
    ...
    model.save('ppo_aoa_random_start_high_variation')
